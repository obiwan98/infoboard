...
export function AlertOverlay() {
  ...
  return (
    <div className="pointer-events-none absolute inset-0 z-50 flex items-center justify-center bg-slate-950/55 backdrop-blur-[4px]">
      <div
        className={`pointer-events-auto w-[min(90%,520px)] rounded-xl border p-5 shadow-2xl ${
          alert.level === "warning"
            ? "border-amber-300/35 bg-slate-950/92"
            : "border-[color:var(--mm-line)] bg-slate-950/92"
        }`}
      >
        <div className="flex items-start justify-between gap-4">
          ...
          <button
            ...
            className="mm-dim rounded px-2 py-1 text-sm transition-colors hover:text-white"
