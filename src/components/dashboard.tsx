...
const widgetFrameClass: Record<WidgetId, string> = {
  ...
  news: "col-span-1 row-span-1 min-h-[220px] w-full min-w-0 min-[480px]:col-span-2 min-[480px]:row-span-1",
  calendar: "col-span-1 row-span-1 min-h-[460px] w-full min-w-0 min-[480px]:col-span-2 min-[480px]:row-span-3",
};
